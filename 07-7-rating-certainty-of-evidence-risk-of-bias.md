...
Before starting in to well established approaches to risk of bias assessment, we must provide a warning and a suggestion. The systematic review community has become aware of the distressing frequency of studies that are completely untrustworthy because of inaccurate reporting of methods or outright fraud. <mark style="color:blue;">Systematic review authors must therefore consider beginning with a check for such studies. A number of instruments are available (e.g.,</mark> [<mark style="color:blue;">TRACT checklist</mark>](https://fairsharing.org/10.25504/FAIRsharing.d03f23/)<mark style="color:blue;">,</mark> [<mark style="color:blue;">IPD Integrity Tool</mark>](https://pubmed.ncbi.nlm.nih.gov/39136348/)<mark style="color:blue;">,</mark> [<mark style="color:blue;">INSPECT-SR</mark>](https://inspect.sr/)<mark style="color:blue;">). For studies that fail this check and are likely, or highly likely to be untrustworthy, reviewers should note their existence but then discard them altogether or include them only in a secondary sensitivity analysis.</mark> Limitations of including problematic studies in sensitivity analyses, however, include generating importantly different (and misleading) estimates, and false precision and consequently misleading certainty of evidence ratings.
...
A large number of instruments are available for assessing risk of bias in NRSI. Core GRADE users might consider the relatively simple, straightforward Newcastle-Ottawa quality assessment scale or modifications of that instrument for both [cohort and case-control studies developed by the CLARITY group](https://www.clarityresearch.ca/ebm-implementation-tools/risk-of-bias-instrument-for-use-in-systematic-reviews-for-randomised-controlled-trials-robust-rct).
...
For example, in a [systematic review of randomised controlled trials addressing the effect of gastrointestinal bleeding prophylaxis with proton pump inhibitors among critically ill patients](https://pubmed.ncbi.nlm.nih.gov/38874580/), the authors used [ROBUST-RCT ](https://www.clarityresearch.ca/risk-of-bias-instrument-in-systematic-reviews)to assess risk of bias. Regarding the threshold of overall risk of bias in individual trials, if reviewers rated at least one item as high risk of bias, authors considered the trial as overall high risk of bias. In contrast, the [systematic review of cohort studies examining the impact of red and processed meat consumption on cardiometabolic outcomes ](https://doi.org/10.7326/M19-0655)used CLARITY's modified instrument to rate risk of bias in the included cohort studies and required two or more of the seven items (authors omitted one irrelevant item) rated as high risk of bias to consider the overall risk of bias as high. Finally, in another [systematic review evaluating the effect of using an antipsychotic drug on fracture risk](https://pubmed.ncbi.nlm.nih.gov/29688914/), for the included cohort studies the authors used CLARITY's modified instrument to rate their risk of bias and considered a study at overall high risk of bias only if three or more of the eight items were assessed as high risk of bias.
